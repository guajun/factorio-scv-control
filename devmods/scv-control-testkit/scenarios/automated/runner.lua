...
local ComparisonContractTests = require("__scv-control-testkit__/comparison/contract_tests")
local UnifiedAdapterTests = require("__scv-control-testkit__/unified/adapter_contract_tests")
...
local function run_unit_tests(surface)
  ...
  ComparisonContractTests.run(expect)
  UnifiedAdapterTests.run(expect)
